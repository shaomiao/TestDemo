...
import com.project.testdemo.adapter.TextAdapter;
...
//			{ "全部", "意面披萨", "西式快餐", "其他西餐" }, { "全部", "韩式简餐", "韩国料理" } };
	...
	//数据
	public ChildView(Context context, String LeftFaString[], String LeftCh1String[][]) {
		super(context);
		this.LeftFaString = LeftFaString;
		this.LeftCh1String = LeftCh1String;
		init(context);
	}
	...
	private void init(Context context) {
		...
		for(int i=0;i<(LeftFaString.length<10?LeftFaString.length:10);i++){
